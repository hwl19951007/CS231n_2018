...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        hidden1, cache1 = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        ...
        dhidden2, grads["W3"], grads["b3"] = affine_backward(dscores, cache3)
        dhidden1, grads["W2"], grads["b2"] = affine_relu_backward(dhidden2, cache2)
        dX, grads['W1'], grads['b1'] = conv_relu_pool_backward(dhidden1, cache1)
